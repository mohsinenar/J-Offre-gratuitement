...
<template>
  <div>
    <div  style="padding:20xp !important" class="box is-clearfix is-paddingless is-fullwidth">
      <!-- side menu button  -->
      <b-button
      ...
      <div style="padding:10px">
        <b-menu>
          <b-menu-list label="Menu">
            ...
            <b-menu-item @click="Goto('AddListing')" label="Ajouter une Annonce"></b-menu-item>
            <b-menu-item @click="Goto('MyOffres')" label="mes annonces"></b-menu-item>
          </b-menu-list>
...
export default {
  data: function() {
    return {
      NavbareOpen: false,
      logedUser: this.$store.state.Auth.logedUser
    };
  },
  computed: {
    isLoged: function() {
      return this.$store.state.Auth.logedUser.isLoged;
    },
    isSub: function() {
